...
### 6. 灭运三改名 — ✅ 已完成（`c072c80`，审计中落地并复测：412 测试 + build 全绿）
- ~~境界显示名：`凡尘`→**未录**、`通玄`→**窥命**~~ ✅
- ~~货币显示名：`灵石`→**玄晶**~~ ✅ · ~~市场名 **万法坊**~~ ✅
- G8 四作术语至此零重合（烂柯按裁定保留 凡尘/通玄）

### 7. README 快捷键表 — ✅ 已完成（烂柯 README「快捷键」节 + 灭运 `9a481c5` Keyboard 节）

## P2 — 质量增强（非阻塞）

### 8. 灭运 `tulu_chushi` bot 实证 — ✅ 已完成（`7c156d9` 打开图录链，reachability 可玩路径实证；415 测试全绿）
...
| 6 | P1 | 灭运 data/UI 文案 | ✅ `c072c80` |
| 7 | P1 | 两份 README 各一节 | ✅ 烂柯+灭运（`9a481c5` 等） |
| 8 | P2 | 图录链可玩达 | ✅ `7c156d9` |
| 9 | P2 | 根游戏历史债 | 待认领（可选） |
| 10 | P3 | 脚本已就绪，仅执行 | 等 P0 |
