...
| 代理 | 状态 | 要点 |
|------|------|------|
| R3-F1 终审 | ✅ | [AUDIT_FINAL_R3.md](./AUDIT_FINAL_R3.md) + [ROUND3_PRIORITIES.md](./ROUND3_PRIORITIES.md) · 基准 `48ded19` 增审至 `eae1ddc` · 969 测试全绿 |
| R3 道君攻坚 | 🔄 | `cursor/daojun-r3-sota-a9cb` 分支：G4 市场/斗法 + G9 信封/审计链重做中 |
| R3 G8 改名 | ✅ | 烂柯 弈者/墟市 ✅ · 道君 观纹七阶/玄玉 ✅ · 灭运 未录/窥命/玄晶/万法坊 ✅（`c072c80`）· 四作术语零重合 |

**终审裁定（G0–G11 计分）**：烂柯 11.5/12 ✅ 可发布 · 灭运 11/12 ✅ 可发布（补 lint 门）· 凡人 10/12 ✅ 基线可发布 · **道君 6/12 ❌ 不可发布**（G3/G4/G6/G9 结构缺口，修复未合入）。
